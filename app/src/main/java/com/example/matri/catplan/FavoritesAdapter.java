...
public class FavoritesAdapter  extends ArrayAdapter<Courses> {
    public List<Boolean> check;
    FavoritesAdapter(Context context, List<Courses> courses) {
        super(context, R.layout.activity_favorites, courses);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.activity_favorites, parent, false);


        Courses c = getItem(position);

        TextView courseName  = (TextView) row.findViewById(R.id.schedule);
